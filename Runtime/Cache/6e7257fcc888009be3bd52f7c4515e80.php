...
<script src="__APP__/__GROUP__/js/common.js"></script>
    <link href="__APP__/__GROUP__/css/bootstrap-datetimepicker.min.css" rel="stylesheet" media="screen">
    <script type="text/javascript" src="__APP__/__GROUP__/js/bootstrap-datetimepicker.min.js" charset="UTF-8"></script>
    <script type="text/javascript" src="__APP__/__GROUP__/js/bootstrap-datetimepicker.zh-CN.js" charset="UTF-8"></script>
                ...
                <form id="jobinfo" class="form-horizontal clearfix">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10 input-group date form_datetime" id="begin_time">
                            <input name="begin_time" type="text" class="form-control" readonly placeholder="到岗时间" />
...
<div class="panel panel-default">
  ...
  <p class="hidden"><script src="http://s11.cnzz.com/z_stat.php?id=1255390287&web_id=1255390287" language="JavaScript"></script></p>
    ...
    <script type="text/javascript" src="__APP__/__GROUP__/js/map.js"></script>
    <script type="text/javascript">
    //Modal
